...
(function ($) {
  ...
  $("ul.term-list").each(function () {
    ...
    if (len > 5) {
      ...
      $(this).append(
        '<li class="more"><a href="javascript:void(0);"><i class="bx bx-plus-circle"></i> More Categories</a></li>'
      );
    }
  });
  $("ul.term-list").on("click", ".more", function () {
    if ($(this).hasClass("less")) {
      $(this)
        ...
        .removeClass("less")
        .append(
          '<a href="javascript:void(0);"><i class="bx bx-plus-circle"></i> More Categories<a>'
        );
    } else {
      $(this)
        .text("")
        .addClass("less")
        .append(
          '<a href="javascript:void(0);"><i class="bx bx-minus-circle"></i> Less Categories<a>'
        );
    }
  ...
  $("ul.amene-list").each(function () {
    ...
    if (len > 5) {
      $("li", this).eq(4).nextAll().hide().addClass("toggleable");
      $(this).append(
        '<li class="more"><a href="javascript:void(0);"><i class="bx bx-plus-circle"></i> More Amenities</a></li>'
      );
    }
  });
  ...
  $("ul.amene-list").on("click", ".more", function () {
    if ($(this).hasClass("less")) {
      $(this)
        ...
        .removeClass("less")
        .append(
          '<a href="javascript:void(0);"><i class="bx bx-plus-circle"></i> More Amenities</a>'
        );
    } else {
      $(this)
        .text("")
        .addClass("less")
        .append(
          '<a href="javascript:void(0);"><i class="bx bx-minus-circle"></i> Less Amenities</a>'
        );
    }
    $(this).siblings("li.toggleable").slideToggle();
  });
